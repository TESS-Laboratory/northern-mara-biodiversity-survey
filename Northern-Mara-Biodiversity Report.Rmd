---
title: "**Report on Avian and Plant Species Biodiversity Baseline Survey Conducted in the Northern Mara between 6th to 21st November 2024**"
author: |
...
\begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{images/invasive01.JPG}
    \caption{\textit{Caesalpinia decapetala}}
    \label{fig:invasive_a}
\end{subfigure} &
\begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{images/invasive02.JPG}
    \caption{\textit{Parthenium hysterophorus}}
    \label{fig:invasive_b}
\end{subfigure} \\
\begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{images/invasive03.JPG}
    \caption{\textit{Senecio madagascariensis}}
    \label{fig:invasive_c}
\end{subfigure} &
\begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{images/invasive04.JPG}
    \caption{\textit{Austrocylindropuntia subulata}}
    \label{fig:invasive_d}
\end{subfigure} \\
\end{tabular}
\caption{Photographs of invasive species observed during the Northern Mara biodiversity survey.}
\label{fig:invasive_species}
\end{figure}
\newpage
